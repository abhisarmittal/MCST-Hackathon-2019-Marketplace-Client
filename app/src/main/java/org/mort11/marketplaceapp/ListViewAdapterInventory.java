...
public class ListViewAdapterInventory extends ArrayAdapter<Product> {

    public ListViewAdapterInventory(@NonNull Context context) {
        super(context, R.layout.product_layout_inventory, ProductHolder.productsBought);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.product_layout_inventory, parent, false);
